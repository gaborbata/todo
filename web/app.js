...
Opal.modules["todo"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var $nesting = [self].concat($parent_nesting), $Todo_execute$1, $Todo_to_s$2, $Todo_to_html$3, $Todo_usage$4, $Todo_setup$7, $Todo_load_tasks$11, $Todo_write_tasks$13, $Todo_postprocess_tags$15, $Todo_add$16, $Todo_append$17, $Todo_rename$18, $Todo_delete$19, $Todo_change_state$20, $Todo_set_priority$21, $Todo_due_date$22, $Todo_list$23, $Todo_add_note$27, $Todo_delete_note$28, $Todo_show$29, $Todo_cleanup$31, $Todo_filter_tasks$33, $Todo_colorize$36, $Todo_convert_due_date$37;
    ...
    Opal.def(self, '$execute', $Todo_execute$1 = function $$execute(arguments$) {
      var self = this, action = nil, args = nil, $ret_or_1 = nil, $case = nil, $ret_or_2 = nil, $ret_or_3 = nil, $ret_or_4 = nil, $ret_or_5 = nil, $ret_or_6 = nil, $ret_or_7 = nil, $ret_or_8 = nil, $ret_or_9 = nil, error = nil;
      ...
      try {
        ...
        if ($truthy((function() {if ($truthy(($ret_or_9 = args['$nil?']()))) {
          return $ret_or_9
        } else {
          return args['$empty?']()
        }; return nil; })())) {
    ...
    Opal.def(self, '$to_s', $Todo_to_s$2 = function $$to_s() {
      ...
      return $rb_plus((function() {if ($truthy(($ret_or_10 = self.text_buffer))) {
        return $ret_or_10
      } else {
        return []
      }; return nil; })().$join("\n"), "\n")
    ...
    Opal.def(self, '$load_tasks', $Todo_load_tasks$11 = function $$load_tasks(item_to_check) {
      var $$12, self = this, count = nil, tasks = nil, todo_jsonl = nil, $ret_or_11 = nil;
      ...
      if ($truthy((function() {if ($truthy(($ret_or_11 = item_to_check))) {
    ...
    Opal.def(self, '$change_state', $Todo_change_state$20 = function $$change_state(item, state, note) {
      var self = this, tasks = nil, $writer = nil, $ret_or_12 = nil, $logical_op_recvr_tmp_1 = nil, $ret_or_13 = nil;
      ...
      $send(tasks['$[]'](item), '[]=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      if ($truthy((function() {if ($truthy(($ret_or_12 = note['$nil?']()['$!']()))) {
        return note['$empty?']()['$!']()
      } else {
        return $ret_or_12
      }; return nil; })())) {
        ...
        if ($truthy(($ret_or_13 = $logical_op_recvr_tmp_1['$[]']("note")))) {
          $ret_or_13
        } else {
    ...
    Opal.def(self, '$set_priority', $Todo_set_priority$21 = function $$set_priority(item, note) {
      var self = this, tasks = nil, $writer = nil, $ret_or_14 = nil, $logical_op_recvr_tmp_2 = nil, $ret_or_15 = nil;
      ...
      $send(tasks['$[]'](item), '[]=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      if ($truthy((function() {if ($truthy(($ret_or_14 = note['$nil?']()['$!']()))) {
        return note['$empty?']()['$!']()
      } else {
        return $ret_or_14
      }; return nil; })())) {
        ...
        if ($truthy(($ret_or_15 = $logical_op_recvr_tmp_2['$[]']("note")))) {
          $ret_or_15
        } else {
    ...
    Opal.def(self, '$list', $Todo_list$23 = function $$list(tasks, patterns) {
      var $$24, $$25, self = this, $ret_or_16 = nil, task_indent = nil, $ret_or_17 = nil, items = nil;
      ...
      tasks = (function() {if ($truthy(($ret_or_16 = tasks))) {
        return $ret_or_16
      } else {
        return self.$load_tasks()
      }; return nil; })();
      task_indent = [tasks.$keys().$max().$to_s().$size(), 4].$max();
      patterns = (function() {if ($truthy((function() {if ($truthy(($ret_or_17 = patterns['$nil?']()))) {
        return $ret_or_17
      } else {
      ...
      items = $send(items, 'sort_by', [], ($$24 = function(num, task){var self = $$24.$$s == null ? this : $$24.$$s, $ret_or_18 = nil, $ret_or_19 = nil, $ret_or_20 = nil;
        ...
        return [(function() {if ($truthy((function() {if ($truthy(($ret_or_18 = task['$[]']("priority")))) {
          ...
          return "n/a"
        }; return nil; })(), num];}, $$24.$$s = self, $$24.$$arity = 2, $$24));
      $send(items, 'each', [], ($$25 = function(num, task){var self = $$25.$$s == null ? this : $$25.$$s, $$26, state = nil, $ret_or_21 = nil, color = nil, display_state = nil, title = nil, priority_flag = nil, due_date = nil, $ret_or_22 = nil, date_diff = nil, $ret_or_23 = nil, $ret_or_24 = nil;
        if (self.today == null) self.today = nil;
        ...
        title = $send(task['$[]']("title"), 'gsub', [$$($nesting, 'CONTEXT_TAG_PATTERN')], ($$26 = function(tag){var self = $$26.$$s == null ? this : $$26.$$s;
          ...
          return $rb_plus((function() {if ($truthy(tag['$start_with?'](" "))) {
            ...
            return ""
          }; return nil; })(), self.$colorize(tag.$strip(), "cyan"));}, $$26.$$s = self, $$26.$$arity = 1, $$26));
        ...
        return self.text_buffer.$push("" + (num.$to_s().$rjust(task_indent, " ")) + ":" + (priority_flag) + (display_state) + " " + (title) + (due_date));}, $$25.$$s = self, $$25.$$arity = 2, $$25));
    ...
    Opal.def(self, '$add_note', $Todo_add_note$27 = function $$add_note(item, text) {
    ...
    }, $Todo_add_note$27.$$arity = 2);
    
    Opal.def(self, '$delete_note', $Todo_delete_note$28 = function $$delete_note(item) {
      var self = this, tasks = nil, $writer = nil;
      ...
      self.$write_tasks(tasks);
      return self.$show(item);
    }, $Todo_delete_note$28.$$arity = 1);
    
    Opal.def(self, '$show', $Todo_show$29 = function $$show(item) {
      var $$30, self = this, tasks = nil;

      
      tasks = self.$load_tasks(item);
      return $send(tasks['$[]'](item), 'each', [], ($$30 = function(key, value){var self = $$30.$$s == null ? this : $$30.$$s, val = nil;
        if (self.text_buffer == null) self.text_buffer = nil;
        ...
        return self.text_buffer.$push("" + (self.$colorize($rb_plus(key.$to_s().$rjust(10, " "), ":"), "cyan")) + " " + (val));}, $$30.$$s = self, $$30.$$arity = 2, $$30));
    }, $Todo_show$29.$$arity = 1);
    
    Opal.def(self, '$cleanup', $Todo_cleanup$31 = function $$cleanup(patterns) {
      var $$32, self = this, tasks = nil, items = nil;

      
      tasks = self.$load_tasks();
      patterns = $rb_plus([":done"], patterns.$to_a());
      items = self.$filter_tasks(tasks, patterns);
      $send(items.$keys(), 'each', [], ($$32 = function(num){var self = $$32.$$s == null ? this : $$32.$$s;
        ...
        return tasks.$delete(num);}, $$32.$$s = self, $$32.$$arity = 1, $$32));
      self.$write_tasks(tasks);
      return self.text_buffer.$push("" + "Deleted " + (items.$size()) + " todo(s)");
    }, $Todo_cleanup$31.$$arity = 1);
    
    Opal.def(self, '$filter_tasks', $Todo_filter_tasks$33 = function $$filter_tasks(tasks, patterns) {
      var $$34, self = this, items = nil;

      
      items = $hash2([], {});
      $send(tasks, 'each', [], ($$34 = function(num, task){var self = $$34.$$s == null ? this : $$34.$$s, $$35, normalized_task = nil, match = nil, $writer = nil;
        ...
        match = true;
        $send(patterns, 'each', [], ($$35 = function(pattern){var self = $$35.$$s == null ? this : $$35.$$s, $ret_or_26 = nil;
          ...
          if ($truthy(Opal.regexp([(function() {if ($truthy(($ret_or_26 = self.queries['$[]'](pattern)))) {
            return $ret_or_26
          } else {
            return pattern
      ...
      return items;
    }, $Todo_filter_tasks$33.$$arity = 2);
    
    Opal.def(self, '$colorize', $Todo_colorize$36 = function $$colorize(text, color) {
      var self = this;

      return "" + "\e[" + ($$($nesting, 'COLOR_CODES')['$[]'](color)) + "m" + (text) + "\e[0m"
    }, $Todo_colorize$36.$$arity = 2);
    return (Opal.def(self, '$convert_due_date', $Todo_convert_due_date$37 = function $$convert_due_date(date) {
      var $$38, self = this, due = nil, day_index = nil, $ret_or_27 = nil, $ret_or_28 = nil, $ret_or_29 = nil;
      ...
      due = nil;
      day_index = (function() {if ($truthy(($ret_or_27 = (function() {if ($truthy(($ret_or_28 = self.due_date_days.$index(date.$to_s().$downcase())))) {
        return $ret_or_28
      } else {
        ...
        return $send(self.due_date_days, 'map', [], ($$38 = function(day){var self = $$38.$$s == null ? this : $$38.$$s;
          ...
          return day['$[]']($range(0, 2, false));}, $$38.$$s = self, $$38.$$arity = 1, $$38)).$index(date.$to_s().$downcase())
      }; return nil; })();
      if ($truthy(day_index)) {
        due = $rb_plus(self.today, day_index).$strftime($$($nesting, 'DATE_FORMAT'))
      } else {
        due = (function() {if ($truthy((function() {if ($truthy(($ret_or_29 = date['$nil?']()))) {
          return $ret_or_29
        } else {
          return date['$empty?']()
        }; return nil; })())) {
      ...
      return due;
    }, $Todo_convert_due_date$37.$$arity = -1), nil) && 'convert_due_date';
  })($nesting[0], null, $nesting);
};
